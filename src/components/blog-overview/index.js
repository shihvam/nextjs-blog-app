...
function BlogOverview({ blogList }) {
  ...
  function handleEdit(getCurrentBlog){
    ...
    return  <div className="min-h-screen flex flex-col gap-10 bg-gradient-to-r from-purple-500 to-blue-600 p-6" > 
    ...
    <div className="grid grid-col-1 sm:grid-cols2 lg: grid-cols-3 gap-6 mt-5" >
      {
